...
- (void)setupBasicView {
    ...
    iconBackView.layer.borderColor = [UIColor colorWithHexString:@"efefef"].CGColor;
    ...
    [iconImgView setImage:[UIImage imageNamed:@"timg"]];
    ...
    goodsNameLbl.text = @"汽车防冻玻璃水";
    goodsNameLbl.textColor = [UIColor colorWithHexString:@"666"];
    ...
    goodsPriceLbl.text = @"¥ 15.8-28.8";
    goodsPriceLbl.textColor = [UIColor redColor];
    ...
    sureBtn.backgroundColor = [UIColor colorWithHexString:@"0081f1"];
...
- (void)setGoodAttrsArr:(NSArray *)goodAttrsArr {
    ...
    for (int i = 0; i < attrValueArr0.count ; i++) {
        ...
        [btn defaultStyleWithNormalTitleColor:HX_RGB(136, 137, 138) andHighTitleColor:[UIColor whiteColor] andBorderColor:[UIColor colorWithHexString:@"efefef"] andBackgroundColor:[UIColor whiteColor] andHighBgColor:[UIColor colorWithHexString:@"0081f1"] andSelectedBgColor:[UIColor colorWithHexString:@"0081f1"] withcornerRadius:8];
    ...
    [minusBtn defaultStyleWithNormalTitleColor:[UIColor blackColor] andHighTitleColor:HX_RGB(125, 125, 125) andBorderColor:[UIColor colorWithHexString:@"efefef"] andBackgroundColor:HX_RGB(250, 250, 250) andHighBgColor:HX_RGB(220, 220, 220) withcornerRadius:1];
    ...
    buyNumsLbl.layer.borderColor = [UIColor colorWithHexString:@"efefef"].CGColor;
    ...
    [plusBtn defaultStyleWithNormalTitleColor:[UIColor blackColor] andHighTitleColor:HX_RGB(125, 125, 125) andBorderColor:[UIColor colorWithHexString:@"efefef"] andBackgroundColor:HX_RGB(250, 250, 250) andHighBgColor:HX_RGB(220, 220, 220) withcornerRadius:1];
