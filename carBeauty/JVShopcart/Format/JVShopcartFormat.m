...
- (void)starProductAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //弹框 告诉用户已经收藏
//    UIAlertController *alert = [UIAlertController alertControllerWithTitle:nil message:[NSString stringWithFormat:@"收藏成功"] preferredStyle:UIAlertControllerStyleAlert];
