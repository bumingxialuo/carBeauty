...
- (void)wave {
    ...
    waveLayer.fillColor = [UIColor colorWithHexString:@"0081f1"].CGColor;
    ...
    boot.image = [UIImage imageNamed:@"pc78yM9Ki"];
...
- (void)fishJump {
    ...
    if (self.fish == nil) {
        ...
        _fish.image = [UIImage imageNamed:@"car2"];
        _fish.width = 20;
        _fish.height = 20;
        _fish.tag = 101;
...
- (void)collisionBehavior:(UICollisionBehavior*)behavior beganContactForItem:(id <UIDynamicItem>)item withBoundaryIdentifier:(id <NSCopying>)identifier atPoint:(CGPoint)p {
    ...
    if (view.tag == 101 && !fishFirstColl) {
        ...
        if (dropView == nil) {
            ...
            dropView.backgroundColor = [UIColor colorWithHexString:@"0081f1"];
        }
        ...
        if (dropView2 == nil) {
            ...
            dropView2.backgroundColor = [UIColor colorWithHexString:@"0081f1"];
        ...
        if (dropView3 == nil) {
            ...
            dropView3.backgroundColor = [UIColor colorWithHexString:@"0081f1"];
