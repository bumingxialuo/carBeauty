//
//  ProductSeachBtnViewController.m
//  carBeauty
//
...
@interface ProductSeachBtnViewController ()

@property(nonatomic, strong) UISearchBar *seachBar;

@end

@implementation ProductSeachBtnViewController
...
- (void)layoutSeachSubview {
    ...
    self.navigationItem.title = @"产品搜索";
